...
for item in range(len(json_dict["kbList"])):
    ...
    if(str(json_dict["kbList"][item]['xqjmc']) == str('星期四') ):
        ...
        if (str(json_dict["kbList"][item]["zcd"][-2]) == str(is_week)
            ...
            lesson_today[0]['lesson_today_have'] = len(lesson_today) - 1
print(is_week)
print(lesson_today)
...
# print(lesson_today[0]['lesson_today_have'])
# print(lesson_today)
#
# print(datetime.datetime.now().isocalendar())
# print(datetime.date(2021, 2, 18).isocalendar())
# print(
# datetime.date(2021, 2, 22).isocalendar()
# )
